...
// 여섯 기관이면 55px 뿐이라 긴 이름은 옆 칸을 침범한다(현재 가장 긴 것은
// '산업연구원' → '산업연'). 2026-09-11 에 기관 표기를 BOK·KLI·KEIS·재정부로
// 통일해 대부분은 약칭이 본 이름과 같아졌지만, 규칙은 남긴다 — 이름이 다시
// 길어질 때 화면이 약칭을 지어내면 안 된다.
...
//   2줄: 발표시기 · 보고서명
//
// 첫 줄은 좁은 폭에서 넘칠 수 있다(기관명이 길고 값·증감·상하반기가 다 붙는
// 조합). 그래서 wrap 을 허용해 상하반기만 아래로
